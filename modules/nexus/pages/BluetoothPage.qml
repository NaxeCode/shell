...
PageBase {
    ...
    ColumnLayout {
        ...
        ItemList {
            ...
            model: ScriptModel {
                values: Bluetooth.devices.values.filter(d => d.bonded).sort((a, b) => (b.connected - a.connected) || Strings.bluetoothDeviceName(a).localeCompare(Strings.bluetoothDeviceName(b))) // qmllint disable unresolved-type
            }
