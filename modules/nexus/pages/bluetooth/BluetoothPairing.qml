...
PageBase {
    ...
    ColumnLayout {
        ...
        ItemList {
            ...
            model: ScriptModel {
                values: Bluetooth.devices.values.filter(d => !d.bonded).sort((a, b) => (b.pairing - a.pairing) || Strings.bluetoothDeviceName(a).localeCompare(Strings.bluetoothDeviceName(b))) // qmllint disable unresolved-type
            }
            ...
            delegate: Item {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: Strings.bluetoothDeviceName(newDevice.modelData)
                            font: Tokens.font.body.small
